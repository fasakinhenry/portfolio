    ...
    <section className="w-full bg-gradient-to-b from-white to-gray-50 py-20">
            ...
            >
              <div 
                ...
                style={{
                  ...
                  transform: hoveredIndex === index ? 'translateZ(10px) rotateX(2deg)' : 'translateZ(0)',
                }}
              >
                {/* Quote icon */}
      ...
      <div className="w-full overflow-hidden transform-none">
        <Marquee
          ...
          direction="right"
        >
          {[...testimonials.slice(3), ...testimonials.slice(0, 3)].map((testimonial, index) => {
              ...
              >
                <div 
                  className={`
                    ...
                    relative p-6 transition-all duration-500 ease-out
                    hover:scale-[1.03] hover:shadow-xl
                    ${hoveredIndex === actualIndex ? 'shadow-xl scale-[1.03]' : 'shadow-md'}
                  `}
                  style={{
                    boxShadow: 'rgba(0, 0, 0, 0.05) 0px 10px 25px -5px, rgba(0, 0, 0, 0.04) 0px 10px 10px -5px',
                    transition: 'transform 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275), box-shadow 0.4s ease',
                    willChange: 'transform, box-shadow',
                    transform: hoveredIndex === actualIndex ? 'translateZ(10px) rotateX(2deg)' : 'translateZ(0)',
                  }}
                >
                  {/* Quote icon */}
                  <div className="text-4xl text-indigo-100 mb-2">"</div>
