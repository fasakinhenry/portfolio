...
const Skills = () => {
  ...
  return (
    <section className='w-screen px-4 py-10 flex justify-center items-center'>
      <div className='w-full max-w-[53rem] flex flex-col items-center relative bg-black px-4 md:px-[5rem] py-[5rem] rounded-xl'>
        <Image
          alt='Doodle'
          loading='lazy'
          decoding='async'
